...
"use client";
// This file is a React component that uses Three.js and Postprocessing to create a dithered wave effect.
...
export default function Dither({
  ...
  // Add window check before accessing window
  ...
  useEffect(() => {
    ...
    // Any window-dependent code should go here with the isClient check
    // Currently none needed for this component
  }, [isClient]);
